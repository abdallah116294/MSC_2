...
import 'package:msc_2/features/auth/sign_in/peresentation/widgets/buttom_part_sign_in_widget.dart';
import 'package:msc_2/features/auth/sign_in/peresentation/widgets/toggel_language_buttom.dart';
import 'package:msc_2/features/auth/sign_in/peresentation/widgets/top_part_sign_in_widget.dart';
      ...
      listener: (context, state) {
        if (state is SignInLoading) {
          ...
          showMessage(
              ...
              isError: false);
          context.pushName(AppRoutes.otpVerificationViewRoute,arguments:state.signInSuccessModel);
          log('Success');
        } else if (state is SignInError) {
          showMessage(message: state.message.toString(), isError: true);
          log('Error');
        }
      },
                  ...
                  child: Stack(
                    children: [
                      ...
                      BottomContainer(
                        ...
                        formKey: _formKey,
                        signInButton: () {
                          cubit.signIN(phoneNumber: phoneController.text);
                        },
